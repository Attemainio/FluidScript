...
{
    private static readonly ImmutableDictionary<string, string> Table = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ["aliceblue"] = "#f0f8ff",
        ["antiquewhite"] = "#faebd7",
        ["aqua"] = "#00ffff",
    ...
    /// <param name="name">The word as written.</param>
    /// <param name="hex">The colour as lower-case <c>#rrggbb</c>.</param>
    /// <returns>Whether the word is a CSS colour name.</returns>
    public static bool TryGet(string name, out string hex) => Table.TryGetValue(name, out hex!);
}
