...
| Tank layer balance in a run, upwind with interface flows; no remix yet | `EquationSystem.TryEvaluateRates` | `TransientSolverTests.TheStorageHeadersSecondLayerWarmsAtTwoHundredthsOfAKelvinPerSecond` (33's cross-check, 0.020 K/s by hand) | — |
| Tank remix and V15–V17 | `33` — not built | — | — (P6.2) |
