...
| `dp` | PressureDelta | kPa | 1 … 5000 | Pressure rise, an alternative to `head`: held exactly by the pump's equation, the head following at the solved density (`C-109`); with `head`, `FS2101` |
