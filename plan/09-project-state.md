...
| P6 | M4 | 9 | **In progress** — P6.0, P6.1, P6.2 and `C-114` shipped 2026-09-22; P6.8a and P6.8b 2026-09-22/23 (the scenario language and its sizing pipeline), `C-121` 2026-09-23 (valve authority and turn-down across scenarios). Next: P6.9 (the source structure, `D-147`/`D-148`, S0–S2 shipped), then `C-120`, then P6.3; the live-curve half waits on `S-79` | — |
| P7 | M5 | 2 | Not started | — |
